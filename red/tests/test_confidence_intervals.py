...
def test_conf_int_initial_sequence_gaussian_noise(gaussian_noise):
    ...
    # = 0.002772
    conf_int = get_conf_int_initial_sequence(gaussian_noise, alpha_two_tailed=0.05)
...
def test_conf_int_initial_sequence_gaussian_noise_widely_offset(gaussian_noise_widely_offset):
    ...
    with pytest.warns(RuntimeWarning):
        conf_int = get_conf_int_initial_sequence(
            gaussian_noise_widely_offset, alpha_two_tailed=0.05
        )
...
def test_conf_int_initial_sequence_low_ess(gaussian_noise_widely_offset):
    ...
    with pytest.warns(RuntimeWarning):
        get_conf_int_initial_sequence(gaussian_noise_widely_offset, alpha_two_tailed=0.05)
