...
def get_variance_series_initial_sequence(
    ...
    """Compute a variance series as samples are discarded, using initial sequence methods.
...
def get_variance_series_window(
    ...
    """Compute a variance series as samples are discarded, using window estimators.
