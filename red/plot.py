...
def plot_equilibration_paired_t_test(
    ...
    r"""Plot the p-values of the paired t-test against time, underneath the time series data.
    ...
    subplot_spec : plt.SubplotSpec
        The subplot spec to use for the plot.
...
def plot_equilibration_min_sse(
    ...
    r"""Plot the squared standard error (SSE) estimates against time.
